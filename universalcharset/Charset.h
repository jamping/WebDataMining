...
typedef unsigned long charset_t;
...
public:
	...
	static charset_t NameToType(const TCHAR* strCharset)
	{
		...
		len = _tcslen(strCharset);

		if (len >= 10 && !_tcsnicmp(strCharset, "ISO-8859-1", 10)) 
		{
			return ISO_8859_1;
		}
		else if (len >= 5 && !_tcsnicmp(strCharset, "UTF-8", 5)) 
		{
			return UTF_8;
		}
		else if (len >= 6 && (!_tcsnicmp(strCharset, "EUC-KR", 6) || !_tcsnicmp(strCharset, "EUC_KR", 6))) 
		{
			return EUC_KR;
		}
		else if (len >= 5 && !_tcsnicmp(strCharset, "EUCKR", 5)) 
		{
			return EUC_KR;
		}
		else if (len >= 11 && !_tcsnicmp(strCharset, "ISO-8859-15", 11)) 
		{
			return ISO_8859_15;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "windows-1252", 12)) 
		{
			return WINDOWS_1252;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "UTF-16", 6)) 
		{
			return UTF_16;
		}
		else if (len >= 6 && (!_tcsnicmp(strCharset, "EUC_JP", 6) || !_tcsnicmp(strCharset, "EUC-JP", 6))) 
		{
			return EUC_JP;
		}
		else if (len >= 5 && !_tcsnicmp(strCharset, "EUCJP", 5)) 
		{
			return EUC_JP;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "KOI8-R", 6)) 
		{
			return KOI8_R;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "KOI8-U", 6)) 
		{
			return KOI8_U;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "ISO-8859-2", 10)) 
		{
			return ISO_8859_2;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "ISO-8859-3", 10)) 
		{
			return ISO_8859_3;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "ISO-8859-4", 10)) 
		{
			return ISO_8859_4;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "ISO-8859-5", 10)) 
		{
			return ISO_8859_5;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "ISO-8859-6", 10)) 
		{
			return ISO_8859_6;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "ISO-8859-6-I", 12)) 
		{
			return ISO_8859_6_I;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "ISO-8859-6-E", 12)) 
		{
			return ISO_8859_6_E;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "ISO-8859-7", 10)) 
		{
			return ISO_8859_7;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "ISO-8859-8", 10)) 
		{
			return ISO_8859_8;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "ISO-8859-8-I", 12)) 
		{
			return ISO_8859_8_I;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "ISO-8859-8-E", 12)) 
		{
			return ISO_8859_8_E;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "ISO-8859-9", 10))
		{
			return ISO_8859_9;
		}
		else if (len >= 11 && !_tcsnicmp(strCharset, "ISO-8859-10", 11))
		{
			return ISO_8859_10;
		}
		else if (len >= 11 && !_tcsnicmp(strCharset, "ISO-8859-11", 11)) 
		{
			return ISO_8859_11;
		}
		else if (len >= 11 && !_tcsnicmp(strCharset, "ISO-8859-13", 11))
		{
			return ISO_8859_13;
		}
		else if (len >= 11 && !_tcsnicmp(strCharset, "ISO-8859-14", 11))
		{
			return ISO_8859_14;
		}
		else if (len >= 11 && !_tcsnicmp(strCharset, "ISO-8859-16", 11)) 
		{
			return ISO_8859_16;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "ISO-IR-111", 10)) 
		{
			return ISO_IR_111;
		}
		else if (len >= 11 && !_tcsnicmp(strCharset, "ISO-2022-CN", 11))
		{
			return ISO_2022_CN;
		}
		else if (len >= 11 && !_tcsnicmp(strCharset, "ISO-2022-CN", 11)) 
		...
		else if (len >= 11 && !_tcsnicmp(strCharset, "ISO-2022-KR", 11))
		{
			return ISO_2022_KR;
		}
		else if (len >= 11 && !_tcsnicmp(strCharset, "ISO-2022-JP", 11))
		{
			return ISO_2022_JP;
		}
		else if (len >= 8 && !_tcsnicmp(strCharset, "us-ascii", 8)) 
		{
			return US_ASCII;
		}
		else if (len >= 8 && !_tcsnicmp(strCharset, "UTF-32BE", 8)) 
		{
			return UTF_32BE;
		}
		else if (len >= 8 && !_tcsnicmp(strCharset, "UTF-32LE", 8)) 
		{
			return UTF_32LE;
		}
		else if (len >= 8 && !_tcsnicmp(strCharset, "UTF-16BE", 8)) 
		{
			return UTF_16BE;
		}
		else if (len >= 8 && !_tcsnicmp(strCharset, "UTF-16LE", 8)) 
		{
			return UTF_16LE;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "windows-1250", 12))
		{
			return WINDOWS_1250;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "windows-1251", 12))
		{
			return WINDOWS_1251;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "windows-1253", 12)) 
		{
			return WINDOWS_1253;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "windows-1254", 12))
		{
			return WINDOWS_1254;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "windows-1255", 12))
		{
			return WINDOWS_1255;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "windows-1256", 12)) 
		{
			return WINDOWS_1256;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "windows-1257", 12))
		{
			return WINDOWS_1257;
		}
		else if (len >= 12 && !_tcsnicmp(strCharset, "windows-1258", 12)) 
		{
			return WINDOWS_1258;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "IBM866", 6)) 
		{
			return IBM866;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "IBM850", 6)) 
		{
			return IBM850;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "IBM852", 6)) 
		{
			return IBM852;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "IBM855", 6))
		{
			return IBM855;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "IBM857", 6)) 
		{
			return IBM857;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "IBM862", 6))
		{
			return IBM862;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "IBM864", 6)) 
		{
			return IBM864;
		}
		else if (len >= 7 && !_tcsnicmp(strCharset, "IBM864i", 7)) 
		{
			return IBM864I;
		}
		else if (len >= 5 && !_tcsnicmp(strCharset, "UTF-7", 5)) 
		{
			return UTF_7;
		}
		else if (len >= 9 && !_tcsnicmp(strCharset, "Shift_JIS", 9))
		{
			return SHIFT_JIS;
		}
		else if (len >= 4 && !_tcsnicmp(strCharset, "Big5", 4)) 
		{
			return BIG5;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "GB2312", 6)) 
		{
			return GB2312;
		}
		else if (len >= 7 && !_tcsnicmp(strCharset, "gb18030", 7)) 
		{
			return GB18030;
		}
		else if (len >= 6 && !_tcsnicmp(strCharset, "VISCII", 6)) 
		{
			return VISCII;
		}
		else if (len >= 7 && !_tcsnicmp(strCharset, "TIS-620", 7))
		{
			return TIS_620;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "HZ-GB-2312", 10))
		{
			return HZ_GB_2312;
		}
		else if (len >= 10 && !_tcsnicmp(strCharset, "Big5-HKSCS", 10)) 
		{
			return BIG5_HKSCS;
		}
		else if (len >= 5 && !_tcsnicmp(strCharset, "x-gbk", 5)) 
		{
			return X_GBK;
		}
		else if (len >= 8 && !_tcsnicmp(strCharset, "x-euc-tw", 8)) 
		{
			return X_EUC_TW;
		}
		else 
	...
	static string TypeToName(charset_t _charset)
	{
