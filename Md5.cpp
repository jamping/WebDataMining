...
{                                                               \
    (n) = (unsigned long int) ((unsigned char *) b)[(i)]                           \
      | (((unsigned long int) ((unsigned char *) b)[(i)+1]) <<  8)                 \
      | (((unsigned long int) ((unsigned char *) b)[(i)+2]) << 16)                 \
      | (((unsigned long int) ((unsigned char *) b)[(i)+3]) << 24);                \
}
...
void CMD5::md5_process( struct md5_context *ctx, unsigned char data[64] )
{
...
void CMD5::md5_update( struct md5_context *ctx, unsigned char *input, unsigned long int length )
{
...
void CMD5::md5_finish( struct md5_context *ctx, unsigned char digest[16] )
{
