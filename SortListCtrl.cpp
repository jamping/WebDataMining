...
BEGIN_MESSAGE_MAP(CSortListCtrl, CComboListCtrl)
...
void CSortListCtrl::PreSubclassWindow()
{
  ...
  CComboListCtrl::PreSubclassWindow();
...
int CSortListCtrl::AddItem(CStringArray& aryItemTexts)
{
	...
	{
		VERIFY( CListCtrl::SetItem( iIndex, iColumn, LVIF_TEXT, arrpsz[iColumn], 0, 0, 0, 0 ) );
	}
...
{
	m_iNumColumns=0;
	CComboListCtrl::DeleteAllColumn();
}
